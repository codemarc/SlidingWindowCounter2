...
public class AppModule {
    ...
    public SignatureKey signatureKey() {
         return new SignatureKey("2409859842589322586 swc2 8ab92129-823d-48f9-8940-abf209264009 SlidingWindowCounter2".getBytes(Charsets.UTF_8));
    }
    ...
    public ConfigSupplier appConfigSupplier(ConfigLoader configLoader) {
        // Load settings.properties in net.codemarc package as a set of config entries
        return configLoader.fromResource("net/codemarc/settings");
    }
